...
class DuplexSTTModel(LightningModule, HFHubMixin):
    def __init__(self, cfg: dict) -> None:
        ...
        # Load LLM first — bf16 to halve GPU footprint (9B×2B=18GB vs 36GB fp32)
            ...
            if os.path.isdir(self.cfg.pretrained_s2s_model) and self.cfg.get("incremental_loading", False):
                ...
                with safe_open(
                    ...
                    for key in available_keys:
                        # Checkpoint may carry NemotronVoiceChat-level prefixes (stt_model.*, tts_model.*).
                        # Strip stt_model. so DuplexSTTModel keys match; skip tts_model.* keys.
                        if key.startswith("stt_model."):
                            model_key = key[len("stt_model."):]
                        ...
                        if model_key in model_state_dict:
                            ...
                            model_state_dict[model_key].copy_(tensor)
