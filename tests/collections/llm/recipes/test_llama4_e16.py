...
from nemo.collections.llm.recipes import llama4_e16
from nemo.lightning import Trainer


class TestLlama4_E16:
    ...
    def test_model(self, recipe_module):
        ...
        assert model_config.config.__fn_or_cls__ == Llama4Experts16Config
    ...
    def test_trainer(self, recipe_module):
        ...
        assert trainer_config.strategy.expert_model_parallel_size == 16
