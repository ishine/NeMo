...
from nemo.collections.llm.recipes import qwen25_14b
from nemo.lightning import Trainer


class TestQwen25_14B:
    ...
    def test_pretrain_recipe(self, recipe_module):
        ...
        assert recipe.trainer.strategy.tensor_model_parallel_size == 4  # Different from 7B model
