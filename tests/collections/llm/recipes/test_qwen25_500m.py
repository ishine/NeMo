...
from nemo.collections.llm.recipes import qwen25_500m
from nemo.lightning import Trainer


class TestQwen25_500M:
    ...
    def test_pretrain_recipe(self, recipe_module):
        ...
        assert recipe.trainer.strategy.tensor_model_parallel_size == 1  # No parallelism needed
        assert recipe.trainer.strategy.pipeline_model_parallel_size == 1
        assert recipe.trainer.num_nodes == 1  # Single node is sufficient
    ...
    def test_finetune_recipe_without_peft(self, recipe_module):
        ...
        # No special parallelism settings needed for 500M model
