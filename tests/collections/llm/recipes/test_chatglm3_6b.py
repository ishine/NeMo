...
class TestChatGLM3_6B:
    ...
    def test_model(self, recipe_module):
        ...
        assert model_config.__fn_or_cls__ == ChatGLMModel
        assert isinstance(model_config.config, run.Config)
        assert model_config.config.__fn_or_cls__ == ChatGLM3Config6B
    ...
    def test_pretrain_recipe(self, recipe_module):
        ...
        assert recipe.model.__fn_or_cls__ == ChatGLMModel
