...
from nemo.collections.llm.recipes import qwen25_32b
from nemo.lightning import Trainer


class TestQwen25_32B:
    ...
    def test_pretrain_recipe(self, recipe_module):
        ...
        assert recipe.trainer.strategy.tensor_model_parallel_size == 8  # Different from 14B model
        assert recipe.trainer.strategy.pipeline_model_parallel_size == 2  # Different from 14B model
        assert recipe.trainer.strategy.pipeline_dtype == torch.bfloat16  # New in 32B model
        assert recipe.trainer.num_nodes == 2  # Different from other models
    ...
    def test_finetune_recipe(self, recipe_module):
        ...
        assert recipe.trainer.strategy.tensor_model_parallel_size == 8  # Always 8 for 32B
